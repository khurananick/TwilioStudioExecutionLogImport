...
FAKER_REFRESH_RATE_IN_SECONDS       = 2
ELASTICSEARCH_AUTOPILOT_INDEX_NAME      = "autopilot_execution_logs"
ELASTICSEARCH_AUTOPILOT_TREE_INDEX_NAME = "autopilot_execution_logs_tree"
